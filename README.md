...
### 一键脚本：
```
bash <(curl -Ls https://raw.githubusercontent.com/yuanzhou029/x-ui-yg/main/install.sh)
```
或
```
bash <(wget -qO- https://raw.githubusercontent.com/yuanzhou029/x-ui-yg/main/install.sh)
```
-----------------------------------------------------
